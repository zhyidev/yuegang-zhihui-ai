...
(
    ...
    INDEX idx_knowledge_sha (sha256)
);
...
(
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_knowledge_chunk_index (document_id, chunk_index),
...
(
    ...
    created_at  DATETIME(6)                                       NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    INDEX idx_knowledge_review_document (document_id, created_at)
);
...
(
    ...
    job_type      VARCHAR(24) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    ...
    updated_at    DATETIME(6)                                       NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    INDEX idx_knowledge_index_dispatch (status, next_retry_at)
);
