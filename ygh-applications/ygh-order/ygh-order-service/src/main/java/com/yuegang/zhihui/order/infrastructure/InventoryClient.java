...
public final class InventoryClient {
    ...
    public void reserve(InventoryCommand command) {
        post("/internal/v1/inventory/reserve", command);
    }

    public void confirm(InventoryCommand command) {
        post("/internal/v1/inventory/confirm", command);
    }

    public void release(InventoryCommand command) {
        post("/internal/v1/inventory/release", command);
    }

    public void returnSold(InventoryCommand command) {
        post("/internal/v1/inventory/return-sold", command);
    }
