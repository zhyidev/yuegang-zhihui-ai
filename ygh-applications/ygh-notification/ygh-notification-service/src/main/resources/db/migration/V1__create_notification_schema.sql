...
(
    ...
    channel          VARCHAR(16) CHARACTER SET ascii COLLATE ascii_bin NOT NULL DEFAULT 'IN_APP',
...
(
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_notification_dead_message (message_id)
);
INSERT INTO notification_template(id, code, title_template, content_template)
VALUES (1, 'ORDER_PAID', '订单支付成功', '您的订单 {{referenceId}} 已使用模拟余额支付成功。'),
       (2, 'TRAINING_ASSIGNED', '新的培训任务', '您有新的培训任务：{{courseTitle}}。');
