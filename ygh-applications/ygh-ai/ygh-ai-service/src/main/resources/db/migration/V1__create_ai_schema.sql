...
(
    ...
    PRIMARY KEY (id),
    INDEX idx_ai_conversation_user_time (user_id, updated_at)
);
...
(
    ...
    created_at        DATETIME(6)                                       NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    INDEX idx_ai_message_conversation_time (conversation_id, created_at),
...
(
    ...
    CONSTRAINT fk_ai_citation_message FOREIGN KEY (message_id) REFERENCES ai_message (id) ON DELETE CASCADE
);
...
(
    ...
    created_at     DATETIME(6)                                       NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    INDEX idx_ai_tool_message (message_id)
);
