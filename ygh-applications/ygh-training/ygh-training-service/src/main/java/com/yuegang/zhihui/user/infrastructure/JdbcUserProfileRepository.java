...
import static com.yuegang.zhihui.user.infrastructure.JdbcAddressRepository.blankToNull;
...
public final class JdbcUserProfileRepository implements UserProfileRepository {
    ...
    @Override
    public Optional<UserProfileView> save(long userId, UpdateUserProfileRequest request) { // 保存（新增或更新）
        ...
        private void bindInsert (PreparedStatement s,long userId, UpdateUserProfileRequest r) throws SQLException {
            ...
            setEncrypted(s, 5, userId, "profileEmail", (r.email()));
