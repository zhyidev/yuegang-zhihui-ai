...
/* 成功获得锁后返回持有全凭证。 */
public record RedisLockHandle(String key, @JsonIgnore String owner, Duration lease) { // 定义 Record ， 忽略 JSON 序列化终端 owner 令牌
...
//        RedisDistributedLock.
    ...
    public String toString(){
        return "RedisLockHandle[key=]" + key + "owner=[REDACTED], lease=" + owner + ']';
    }
}
