...
class RedisLoginRateLimiterIntegrationTest {
        ...
        limiter =
                new RedisLoginRateLimiter(
                        ...
                        new LoginRateLimitPolicy(
                                2, Duration.ofMinutes(15), 3, Duration.ofMinutes(15)),
                        "test");
    }
    ...
    void principalAndIpDimensionsAreConsumedAndRejectedIndependently() throws Exception {
        ...
        assertThat(principalBlocked.rejectedDimension())
                .isEqualTo(LoginRateLimitDimension.PRINCIPAL);
        assertThat(principalBlocked.retryAfter())
