...
final class OperationalAuthCommandService implements AuthCommandService {
    ...
    public TokenResponse refresh(RefreshTokenRequest request) {
        return tokenLifecycle.refresh(request);
    }

    @Override
    public OperationResponse logout(LogoutRequest request, String authorization) {
    ...
    @Override
    public OperationResponse confirmPasswordReset(PasswordResetConfirmRequest request) {
